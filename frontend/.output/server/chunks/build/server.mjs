...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DsJog0TQ.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-CJboC6jz.mjs')
  },
  {
    name: "record",
    path: "/record",
    component: () => import('./record-Bga9XVsa.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-u5ICppjh.mjs')
  },
  {
    name: "record2",
    path: "/record2",
    component: () => import('./record2-BAlTA0UD.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-zinc-900 to-zinc-950 text-zinc-100" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DK-PZvIO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B1opWYDH.mjs'));
